...
testEj7 = test [
    ...
    "publicacionesQueLeGustanA 3 (red sin publi) " ~: publicacionesQueLeGustanA redA usuario4 ~?= []
...
publicacion2_4 = (usuario2, "Sed viverra est at augu", [usuario3, usuario5, usuario2])
...
relacionesA = [relacion1_2, relacion1_3, relacion4_1, relacion5_1, relacion3_5, relacion2_3, usuario4_3]
